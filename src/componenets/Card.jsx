...
function Card() {
  return (
    <>
      <div className="w-full h-full text-white flex gap-5 mt-20 pb-20 px-40">
        <div className="box relative w-1/2 h-[50vh] rounded-lg bg-[#004D43] flex justify-center items-center">
        <svg width="300" height="300" viewBox="0 0 72 30" fill="white" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="absolute bottom-10 left-20 px-10 py-3 rounded-full text-lg border-2 border-zinc-200">
            @2019 - 2022
        </div>
        </div>
        <div className="box relative w-1/4 h-[50vh] rounded-lg bg-[#212121] bg-[url('https://ochi.design/wp-content/uploads/2022/04/logo002.svg')] bg-no-repeat bg-center bg-[length:200px] flex justify-center items-center">
        <div className="absolute uppercase bottom-10 left-5 px-7 py-3 rounded-full text-lg border-2 border-zinc-200">
            rating 5.0 on clutch
        </div>
        </div>
        <div className="box relative w-1/4 h-[50vh] rounded-lg bg-[#212121] flex bg-[url('https://ochi.design/wp-content/uploads/2022/04/logo003.png')] bg-no-repeat bg-center justify-center bg-[length:100px] items-center">
        <div className="absolute uppercase bottom-10 left-5 px-7 py-3 rounded-full text-lg border-2 border-zinc-200">
